...
//    root = insert(root, init_short_prod_rule(TOKEN_COUNT + SYMBOL_START, TOKEN_EOF, 0));
    ...
    root = insert(root, init_prod_rule(TOKEN_COUNT + SYMBOL_EXPRESSION_STATEMENT, arr2, 2, 0, FUNC_KEEP_FIRST));
    root = insert(root, init_short_prod_rule(TOKEN_COUNT + SYMBOL_STATEMENT, TOKEN_COUNT + SYMBOL_EXPRESSION_STATEMENT, 0));
...
//    root = insert(root, init_prod_rule(TOKEN_COUNT + SYMBOL_STATEMENTS, arr2, 2, 0, FUNC_CHAIN));
    ...
    // for statement
    int for_arr[MAX_RULE_SIZE] = {TOKEN_FOR, TOKEN_L_PAREN, TOKEN_COUNT+SYMBOL_VAR_DEC, TOKEN_COUNT+SYMBOL_BOOL_EXPR, TOKEN_COUNT + SYMBOL_END_STATEMENT, TOKEN_COUNT+SYMBOL_ASSIGNMENT, TOKEN_R_PAREN, TOKEN_COUNT + SYMBOL_SCOPE};
    root = insert(root, init_prod_rule(TOKEN_COUNT + SYMBOL_FOR, for_arr, 8, 0, FUNC_FOR));
    for_arr[5] = TOKEN_COUNT + SYMBOL_EXPRESSION_STATEMENT;
    root = insert(root, init_prod_rule(TOKEN_COUNT + SYMBOL_FOR, for_arr, 8, 0, FUNC_FOR));
...
//    root = insert(root, init_short_prod_rule(TOKEN_COUNT + SYMBOL_BOOL_EXPR, TOKEN_COUNT + SYMBOL_RELAT_EXPR, 0));
    ...
    root = insert(root, init_short_prod_rule(TOKEN_COUNT + SYMBOL_TYPE, TOKEN_SHORT, 0));
